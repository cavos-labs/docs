...
| `chainId` | string | **Yes** | Chain ID for the Slot chain. You must manually provide the exact internal VM chain ID (e.g., `0x57505f4341564f53` for `WP_CAVOS`) to avoid signature mismatches. |
