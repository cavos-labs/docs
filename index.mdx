...
1. **User authenticates** with Google, Apple, Magic Link, or Email OTP
...
> [!NOTE]
> Your wallet address is computed from your OAuth identity. There are no private keys to manage — your Google or Apple account IS your wallet.

## Choose Your Platform

<Columns cols={2}>
  <Card title="Web SDK" icon="browser" href="/web/installation">
    For React web applications. Google, Apple, Magic Link, and Email OTP authentication.
  </Card>
